...
#craigslist page contains only 360 listings (120 rows of 3)
#function chooses what page to scrape
def scrape_list_urls(max_pages: int):
    all_listings = []
    headers = {
    ...
    for page in range(max_pages):
        offset = page * 360
        url = f"https://sfbay.craigslist.org/search/sfc/apa#search=2~gallery~{offset}"
